...
<div class="contact wthree-3">
    ...
    <div class="col-md-3 content-pro-head1 w3agile-6">
			<br><br><br><br>
			<h2 class="tittle">Expense Details</h2>
		</div>
  <div class="col-md-9 content-pro-head1 w3agile-6">
      <form class="form-horizontal" method="post" action="<?php echo site_url("expenses/addnewexpense")?>" >
                        <div class="control-group <?php echo !empty($descError)?'error':'';?>">
                          <label class="control-label">Description</label>
                          <div class="controls">
                              <input name="desc" type="text"  placeholder="Ex: Painting" value="<?php echo set_value('desc'); ?>">
                        ...
                        <div class="control-group <?php echo !empty($amtError)?'error':'';?>">
                          ...
                          <div class="controls">
                              <input name="amt" type="text" placeholder="Ex: 30.04" value="<?php echo set_value('amt'); ?>">
                        ...
                        <div class="control-group" >
                          ...
                          <div class="controls">
															<input name='edate' type="text" id="datepicker" value="<?php echo set_value('edate'); ?>">
                        ...
                        <div class="control-group ">
                          ...
                          <div class="controls">
                              <input name="remarks" type="text"  placeholder="Ex: Spent on painting new walls" value="<?php echo set_value('remarks'); ?>">
